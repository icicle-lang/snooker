...
public class TestDecompressor implements Configurable, CompressionCodec, DirectDecompressionCodec {
  ...
  throws IOException {
    return new BlockDecompressorStream(in, createDecompressor(),
                                  conf.getInt("io.file.buffer.size", 4*1024));
  }
